...
const seed: EffectiveProperty[] = [
  ...
  { property_name: "site.timezone", property_id: "site.timezone-id", display_name: "Time zone", data_type: "string", required: false, is_set: true, from_contract: true, default_value: "UTC", set_value: "America/Denver", value: "America/Denver", value_id: "v-tz" },
...
function captureWrites(): Call[] {
  ...
  vi.spyOn(globalThis, "fetch").mockImplementation(async (input) => {
    ...
    if (req.method === "PUT") return json({ property_name: "x", property_id: "x-id", value: null, value_id: "v" });

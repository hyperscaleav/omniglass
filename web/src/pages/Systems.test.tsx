...
const properties: EffectiveProperty[] = [
  ...
  { property_name: "room.note", property_type_id: "room.note-id", display_name: "Note", data_type: "string", required: false, is_set: true, from_contract: false, set_value: "corner room", value: "corner room", value_id: "v-note" },
];
...
describe("Systems properties panel", () => {
  ...
  it("stages an override and flushes it to the system's own property route on Save", async () => {
    ...
    vi.spyOn(globalThis, "fetch").mockImplementation(async (input) => {
      ...
      if (req.method === "PUT") {
        return new Response(JSON.stringify({ system: "boardroom", property_name: "seat_count", property_type_id: "seat_count-id", value: 8, value_id: "v-1" }), {
          status: 200,

...
const hqProperties: EffectiveProperty[] = [
  { property_name: "site.timezone", property_type_id: "site.timezone-id", display_name: "Time zone", data_type: "string", required: false, is_set: false, from_contract: true, default_value: "UTC", value: "UTC" },
...
describe("Locations properties panel", () => {
  ...
  it("stages an override and flushes it to the location's own property route on Save", async () => {
    ...
    vi.spyOn(globalThis, "fetch").mockImplementation(async (input) => {
      ...
      if (req.method === "PUT") {
        return new Response(JSON.stringify({ location: "hq", property_name: "site.timezone", property_type_id: "site.timezone-id", value: "America/Denver", value_id: "v-1" }), {
          status: 200,

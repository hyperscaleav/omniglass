...
func TestSetAllows(t *testing.T) {
	cases := []struct {
		...
		{"read floor: acknowledge implies read", []string{"alarm:acknowledge"}, "alarm", "read", true},
		{"explicit acknowledge allowed", []string{"alarm:acknowledge"}, "alarm", "acknowledge", true},
		{"acknowledge does not imply create", []string{"alarm:acknowledge"}, "alarm", "create", false},
		{"no grant on resource denies read", []string{"alarm:acknowledge"}, "component", "read", false},

...
// rewrite it and why a withdrawn value could never leave a fleet.
...
// a fleet that booted the release carrying floor's rule holds today.
...
// for the four types a fleet actually uses.

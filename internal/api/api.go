...
func registerRoutes(api huma.API, gw storage.Gateway, svc *settings.Service, o options) {
	...
	registerStandardRoutes(api, a, gw)
	registerComponentRoutes(api, a, gw)
	registerVendorRoutes(api, a, gw)
	registerDriverRoutes(api, a, gw)
	registerComponentTypeRoutes(api, a, gw)
	registerSystemTypeRoutes(api, a, gw)
	registerProductRoutes(api, a, gw)
	registerEndpointRoutes(api, a, gw)
	...
	registerStandardPropertyRoutes(api, a, gw)
	registerLocationTypePropertyRoutes(api, a, gw)
	registerSystemPropertyRoutes(api, a, gw)
	registerLocationPropertyRoutes(api, a, gw)
	registerProductMetricRoutes(api, a, gw)
	registerStandardMetricRoutes(api, a, gw)
	registerLocationTypeMetricRoutes(api, a, gw)
	registerEffectiveMetricRoutes(api, a, gw)
	registerRoleRoutes(api, a, gw)

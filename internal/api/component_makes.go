...
func registerComponentMakeRoutes(api huma.API, a *authenticator, gw storage.Gateway) {
	...
	}, "make", "read"), func(ctx context.Context, _ *struct{}) (*listComponentMakesOutput, error) {
	...
	}, "make", "create"), func(ctx context.Context, in *createComponentMakeInput) (*componentMakeOutput, error) {
	...
	}, "make", "read"), func(ctx context.Context, in *componentMakePathInput) (*componentMakeOutput, error) {
	...
	}, "make", "update"), func(ctx context.Context, in *updateComponentMakeInput) (*componentMakeOutput, error) {
	...
	}, "make", "delete"), func(ctx context.Context, in *componentMakePathInput) (*struct{}, error) {

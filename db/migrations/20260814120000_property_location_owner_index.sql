...
--
-- The estate projection reads the CURRENT health verdict for every location and
...
-- system: an estate of a few hundred locations scanned it a few hundred times
...
-- (TestEstateProjectionVerdictLookupsAreIndexed), verified failing first.
--

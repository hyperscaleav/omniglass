...
**New group** creates one (name, display name, description); the **name** is an ordinary entity name
(lowercase letters, digits, and hyphens, no dots and no underscores), while the display name is free

...
boardroom, a classroom, a video wall; the standard is the blueprint it is **built to**. One fleet
...
inheritance**: nothing in your fleet points back at that template afterwards. So Omniglass can improve
...
immediately**, so a retune shows up in the fleet's health without waiting for anything to poll.

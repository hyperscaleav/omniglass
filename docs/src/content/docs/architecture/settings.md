...
permissions, or the routes ([ADR-0036](/architecture/decisions/#adr-0036-settings-are-a-reflected-typed-struct-with-generated-client-and-server-validation)).

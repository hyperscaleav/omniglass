...
- **Collection slice (checkpoint 5a): the reachability verdict as a state.** The first honest substrate for
  ...
  See [ADR-0034](/architecture/decisions/#adr-0034-the-reachability-verdict-is-a-built-in-state).
...
- **Collection slice (checkpoint 5g): the derived interface/task model.** The reachability primitives were
  reframed to their honest shape ([ADR-0036](/architecture/decisions/#adr-0036-the-task-is-derived-read-only-plumbing-projected-from-its-interface)):

...
- **Collection slice (checkpoint 5a): the reachability verdict as a state.** The first honest substrate for
  ...
  See [ADR-0019](/architecture/decisions/#adr-0019-the-reachability-verdict-is-a-built-in-state).
...
- **Collection slice (checkpoint 5e): the interface model reframe.** Before its PR, the interface model was
  ...
  [ADR-0020](/architecture/decisions/#adr-0020-an-interface-is-a-device-api-the-interface-type-is-its-transport-not-its-driver);

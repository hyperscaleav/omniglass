...
- **Platform: the settings engine (global level).** The [settings](/architecture/settings/) subsystem ships its first
  ...
  ([ADR-0033](/architecture/decisions/#adr-0033-the-settings-gateway-is-unscoped-only-the-permission-gates-it)), reusing the
  [cascade](/architecture/cascade/) primitive on the principal axis
  ([ADR-0034](/architecture/decisions/#adr-0034-settings-resolve-as-a-cascade-over-principals-with-a-broader-wins-lock)). The

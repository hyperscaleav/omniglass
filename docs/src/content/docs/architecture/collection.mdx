...
:::design[The template authoring model, tracked in #434]
...
:::design[Functions: a trigger plus a step DAG, tracked in #434]
...
:::design[The step DAG and extractors, tracked in #434]
...
:::design[Template inputs, tracked in #434]
